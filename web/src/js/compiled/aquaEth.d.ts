...
export interface EthereumDef {
    castErrorResultU32ToTransaction: (result: { data: number; info: { code: number; message: string; reason: string; success: boolean; }; }, callParams: CallParams<'result'>) => { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; } | Promise<{ data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }>;
    ...
    erc20Transfer: (contractAddress: string, to: string, amount: string, callParams: CallParams<'contractAddress' | 'to' | 'amount'>) => { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; } | Promise<{ data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }>;
    ...
    getTransaction: (id: string, callParams: CallParams<'id'>) => { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; } | Promise<{ data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }>;
    ...
    sendTransaction: (transactionRequest: { chainId: number; data: string; from: string; gasLimit: string; gasPrice: string; maxFeePerGas: string; maxPriorityFeePerGas: string; nonce: number; to: string; transactionRequest: number; value: string; }, callParams: CallParams<'transactionRequest'>) => { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; } | Promise<{ data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }>;
...
export type GetTransactionResult = { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }
...
export type SendTransactionResult = { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }
...
export type Erc20TransferResult = { data: { blockHash: string; blockNumber: string; confirmations: string; raw: string; timestamp: string; type: string; }; info: { code: number; message: string; reason: string; success: boolean; }; }
